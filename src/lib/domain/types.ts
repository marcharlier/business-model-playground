import { z } from 'zod';
import { Currency, CanvasItem as CanvasItemSchema, AssociatedCost, ProductSales, Product, Subscription, FixedCost, UpfrontCost, CostStructure, RevenueStreams, Project } from './schema';
